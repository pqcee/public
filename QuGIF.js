...
function abort(what) {
    try {
        ...
        console.error("Error in abort function:", error);
        // Example: if you want to re-throw the error after handling
        // throw error;
    }
}
...
var _create_GIF = Module["_create_GIF"] = createExportWrapper("create_GIF");
